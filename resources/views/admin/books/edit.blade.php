                                ...
                                <fieldset class="grid grid-cols-4 gap-6 p-6">
                                    ...
                                    <div class="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                                        ...
                                        <div class="col-span-full">
                                            ...
                                            <textarea id="description" name="description" class="w-full rounded-md dark:border-gray-700 dark:text-gray-900">{{ $book->description }}</textarea>
